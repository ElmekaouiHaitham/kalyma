...
const SESSIONS = [
  ...
  },
  {
    ...
    endedDays: 3,
    summary:
      "This vocabulary session covered 50 high-frequency English words used in everyday conversations. We explored word families, collocations, and used context-based exercises to help you naturally remember new words.",
  ...
  ...PAST_SESSIONS.map((s) => ({
    ...
    emoji: s.thumbnail,
    title: s.title,
    endedDays: Math.floor((Date.now() - new Date(s.date).getTime()) / 86400000),
    summary: s.summary,
              ...
              <div className="flex items-center gap-2 mb-2">
                <div className="flex -space-x-2">
                  <div
                    ...
                    style={{ borderColor: "rgba(255,255,255,0.2)", background: "linear-gradient(135deg, #ef4444, #f97316)" }}
                  >
                    SE
                  </div>
                  <div
                    className="w-7 h-7 rounded-full border-2 flex items-center justify-center text-xs font-bold text-white"
                    style={{ borderColor: "rgba(255,255,255,0.2)", background: "linear-gradient(135deg, #8b5cf6, #3b82f6)" }}
                  >
                    JD
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start gap-4 p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-bold text-sm mb-1.5 leading-snug" style={{ color: "#1a2b5e" }}>
                        {session.title}
                      </div>
                      <div className="flex items-center gap-2 mb-2">
                        <span
